...
describe("Winston Integration", () => {
  beforeAll(() => {
    if (!winstonInstalled) {
      console.log("Skipping Winston integration tests - winston not installed. Install with: npm install winston");
    }
  });
  let reforge: Reforge;
  ...
  describe("createWinstonLogger", () => {
    (winstonInstalled ? it : it.skip)("creates a Winston logger with the correct initial level", async () => {
    ...
    (winstonInstalled ? it : it.skip)("includes the logger name in defaultMeta", async () => {
    ...
    (winstonInstalled ? it : it.skip)("merges custom Winston options", async () => {
      const customOptions = {
        transports: [],
        exitOnError: false,
      };
    ...
    (winstonInstalled ? it : it.skip)("maps Reforge log levels to Winston levels correctly", async () => {
  ...
  describe("createWinstonFormat", () => {
    (winstonInstalled ? it : it.skip)("returns a Winston format function", async () => {
